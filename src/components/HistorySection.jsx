...
export default function HistorySection({ content }) {
  ...
  return (
    <>
      <section className="relative overflow-hidden bg-[linear-gradient(180deg,var(--page-bg-muted)_0%,var(--page-bg)_18%,var(--page-bg-soft)_100%)] py-24 md:py-30">
        <div className="absolute inset-0 opacity-40 [background-image:radial-gradient(circle_at_1px_1px,rgba(42,66,49,0.09)_1px,transparent_0)] [background-size:24px_24px]" />
        ...
        <div className="relative mx-auto flex max-w-7xl flex-col gap-16 px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid gap-8 xl:grid-cols-[0.95fr_1.05fr]">
            <article className="rounded-[2.25rem] border border-[color:var(--accent-soft)]/18 bg-[linear-gradient(180deg,rgba(9,79,67,0.96),rgba(4,63,54,0.98))] p-7 text-white shadow-[0_24px_60px_rgba(15,30,20,0.24)] md:p-10">
              ...
              <blockquote className="mt-8 border-l border-[color:var(--accent-soft)]/35 pl-5 font-display text-3xl leading-tight tracking-[-0.04em] text-[#edf5ee] md:text-[2.6rem]">
                {content.quote}
              </blockquote>
            ...
            <article className="overflow-hidden rounded-[2.5rem] border border-black/8 bg-white/85 shadow-[0_22px_60px_rgba(0,0,0,0.14)] backdrop-blur">
              ...
              >
                ...
                />
                <div className="absolute inset-0 bg-[linear-gradient(to_top,rgba(20,16,12,0.22),transparent_45%)] opacity-70 transition duration-300 group-hover:opacity-100" />
                <div className="absolute bottom-5 right-5 rounded-full border border-white/20 bg-black/30 px-4 py-2 text-[0.65rem] font-bold uppercase tracking-[0.24em] text-white backdrop-blur">
          ...
          <div className="grid gap-4 md:grid-cols-3">
            {content.timeline.map((item, index) => (
              <article
                key={item.year}
                className="rounded-[1.75rem] border border-[color:var(--accent)]/15 bg-white/70 p-6 shadow-[0_12px_34px_rgba(0,0,0,0.08)] backdrop-blur"
              >
                <p className="text-[0.65rem] font-bold uppercase tracking-[0.32em] text-[var(--accent-strong)]">
          ...
          <div className="flex flex-col gap-8">
            ...
            <div className="grid gap-6 md:grid-cols-2">
              {content.archivePhotos.map((item, index) => (
                <article
                  key={item.title}
                  className="overflow-hidden rounded-[2rem] border border-black/8 bg-[linear-gradient(180deg,rgba(255,255,255,0.92),rgba(232,239,231,0.96))] shadow-[0_18px_48px_rgba(0,0,0,0.1)]"
                >
                  <div className="relative">
                    <img
                      ...
                      alt={item.title}
                      loading="lazy"
                      className="h-80 w-full object-cover sepia-[0.1] saturate-[0.8]"
                      referrerPolicy="no-referrer"
                    />
                    <div className="absolute inset-0 bg-[linear-gradient(to_top,rgba(21,33,24,0.3),transparent_45%)]" />
